...
public class DateValidator implements Validator{
    ...
    HtmlInputText htmlInputText = (HtmlInputText) arg1;
    String label = htmlInputText.getLabel() == null || htmlInputText.getLabel().trim().equals("") ? htmlInputText.getId() : htmlInputText.getLabel();
    
    if (!isDate ((String)arg2)){
